    ...
    <>
      <div className="flex items-center gap-2">
        <button
          ...
          className="flex h-9 w-9 items-center justify-center rounded-full border border-border bg-card text-muted-foreground shadow-sm
        ...
        <button
          ...
          className="flex h-9 w-9 items-center justify-center rounded-full border border-border bg-primary text-primary-foreground shadow-sm
            font-display text-sm uppercase transition-all duration-150 ease-out hover:shadow-md hover:brightness-105
            active:scale-90"
        >
          {initial ? initial : <User className="h-4.5 w-4.5" strokeWidth={2} />}
        </button>
      </div>
